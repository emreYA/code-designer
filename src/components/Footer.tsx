    ...
    >
      ...
      <div className="mx-auto  p-4 flex flex-col text-center text-neutral-900 md:flex-row md:justify-between">
        ...
        <div className="flex flex-row items-center justify-center space-x-2 mb-2">
          ...
          <a href="https://github.com/emreYA" rel="noreferrer" target="_blank">
            <AiOutlineGithub
          ...
          <a
            href="https://nl.linkedin.com/in/emre-akkas-86496b21b"
            rel="noreferrer"
            target="_blank"
          >
            <AiOutlineLinkedin
          ...
          <a href="mailto:info@codedesigners.nl">
            <AiOutlineMail
              className="hover:-translate-y-1 transition-transform cursor-pointer text-neutral-500"
              size={30}
            />
